...
function sendContactEmail(){
	...
	var userMessage = $('#user-message').html();
	var enqType = $('#enq-type').val();
	var antiSpam = $('#anti-spam-value').val();
	
	var message = "userName=" + userName.serialize;
	var message += "&userEmail=" + userEmail.serialize;
	var message += "&userTwitter=" + userTwitter.serialize;
	var message += "&userWhatsapp=" + userWhatsapp.serialize;
	var message += "&userMessage=" + userMessage.serialize;
	var message += "&enqType=" + enqType.serialize;
	var message += "&antiSpam=" + antiSpam.serialize;
