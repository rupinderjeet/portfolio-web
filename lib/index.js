...
function sendContactEmail(){
	...
	message += "&userEmail=" + userEmail.serialize;
	message += "&userTwitter=" + userTwitter.serialize;
	message += "&userWhatsapp=" + userWhatsapp.serialize;
	message += "&userMessage=" + userMessage.serialize;
	message += "&enqType=" + enqType.serialize;
	message += "&antiSpam=" + antiSpam.serialize;
